...
########### Case of batch runs lp=1 ip =5 alternative gs 2.5 ###################################
...
for i in 1:100
    sim = nothing
    sim = Simulation(BASE_FOLDER * "/applications/workdays_weekends/weekends_paper/lp_1_ip_5_gs2_5/synth_pop_lp1_ip5_gs2_5.toml", label = "alternative gs 2.5")
...
generate(rep, BASE_FOLDER  *  "/applications/workdays_weekends/weekends_paper/lp_1_ip_5_gs2_5")
...
# !!! check the folder path !!!
jldsave(BASE_FOLDER*"/applications/workdays_weekends/weekends_paper/lp_1_ip_5_gs2_5/infections_ag.jld2"; save_ag_data_base)

# !!! check the folder path !!!
save_ag_data = JLD2.load(BASE_FOLDER  *"/applications/workdays_weekends/weekends_paper/lp_1_ip_5_gs2_5/infections_ag.jld2")["save_ag_data_base"]
