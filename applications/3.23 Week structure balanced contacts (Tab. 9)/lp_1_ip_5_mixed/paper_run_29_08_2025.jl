...
########### Case of batch runs lp=1 ip =5 mixed: working contacts 4.2/0; gs contacts 0/17.5 ###################################
...
# !!! check the folder path !!!
    ...
    sim = Simulation(BASE_FOLDER * "/applications/workdays_weekends/weekends_paper/lp_1_ip_5_mixed/synth_pop_lp1_ip5_mixed.toml", label = "mixed lp=1")
...
# !!! check the folder path !!!
generate(rep, BASE_FOLDER  *  "/applications/workdays_weekends/weekends_paper/lp_1_ip_5_mixed")

# get aggregated info on total infections
save_ag_data_base = tick_cases(bd)

# !!! check the folder path !!!
jldsave(BASE_FOLDER*"/applications/workdays_weekends/weekends_paper/lp_1_ip_5_mixed/infections_ag.jld2"; save_ag_data_base)

# !!! check the folder path !!!
save_ag_data = JLD2.load(BASE_FOLDER  *"/applications/workdays_weekends/weekends_paper/lp_1_ip_5_mixed/infections_ag.jld2")["save_ag_data_base"]
