...
########### Case of batch runs lp=5 ip =5 baseline gs 5 ###################################
...
# !!! check the folder path !!!
    ...
    sim = Simulation(BASE_FOLDER * "/applications/workdays_weekends/weekends_paper/lp_5_ip_5_base/synth_pop_lp5_ip5_base.toml", label = "baseline latent period 5")
...
# !!! check the folder path !!!
generate(rep, BASE_FOLDER  *  "/applications/workdays_weekends/weekends_paper/lp_5_ip_5_base")
...
# !!! check the folder path !!!
jldsave(BASE_FOLDER*"/applications/workdays_weekends/weekends_paper/lp_5_ip_5_base/infections_ag.jld2"; save_ag_data_base)

# !!! check the folder path !!!
save_ag_data = JLD2.load(BASE_FOLDER  *"/applications/workdays_weekends/weekends_paper/lp_5_ip_5_base/infections_ag.jld2")["save_ag_data_base"]
