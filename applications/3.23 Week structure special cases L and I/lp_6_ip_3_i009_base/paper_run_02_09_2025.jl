...
########### Case of batch runs lp=6 ip =3 baseline i=0.09 in hh ###################################
...
# !!! check the folder path !!!
    ...
    sim = Simulation(BASE_FOLDER * "/applications/workdays_weekends/weekends_paper/lp_6_ip_3_i009_base/synth_pop_lp6_ip3_i009_base.toml", label = "lp6 ip3 i009 baseline")
...
generate(rep, BASE_FOLDER  *  "/applications/workdays_weekends/weekends_paper/lp_6_ip_3_i009_base")
...
# !!! check the folder path !!!
jldsave(BASE_FOLDER*"/applications/workdays_weekends/weekends_paper/lp_6_ip_3_i009_base/infections_ag.jld2"; save_ag_data_base)

# !!! check the folder path !!!
save_ag_data = JLD2.load(BASE_FOLDER  *"/applications/workdays_weekends/weekends_paper/lp_6_ip_3_i009_base/infections_ag.jld2")["save_ag_data_base"]
