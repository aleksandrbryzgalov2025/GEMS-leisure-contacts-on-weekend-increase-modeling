...
########### Case of batch runs lp= 6 ip=3, i=0.009 in hh 2 after 2 WE days ###################################
#  ##################
...
# !!! check the folder path !!!
    ...
    sim = Simulation(BASE_FOLDER*"/applications/workdays_weekends/weekends_paper/we2_2_lp_6_ip_3_i009/synth_pop_lp6_ip3_i009_we2_2.toml", label = "Workdays 2 weekends 2 lp6")
    run!(sim)
...
# !!! check the folder path !!!
generate(rep, BASE_FOLDER  *  "/applications/workdays_weekends/weekends_paper/we2_2_lp_6_ip_3_i009")

# get aggregated info on total infections
save_ag_data_base = tick_cases(bd)

# !!! check the folder path !!!
jldsave(BASE_FOLDER*"/applications/workdays_weekends/weekends_paper/we2_2_lp_6_ip_3_i009/infections_ag.jld2"; save_ag_data_base)

# !!! check the folder path !!!
save_ag_data = JLD2.load(BASE_FOLDER  *"/applications/workdays_weekends/weekends_paper/we2_2_lp_6_ip_3_i009/infections_ag.jld2")["save_ag_data_base"]
