...
########### Case of batch runs lp= 1 ip=5, 2 after 2 WE days ###################################
#  ##################
...
# !!! check the folder path !!!
    ...
    sim = Simulation(BASE_FOLDER*"/applications/workdays_weekends/weekends_paper/we2_2_lp_1_ip_5/synth_pop_lp1_ip5_we2_2.toml", label = "Workdays 2 weekends 2 lp1")
    run!(sim)
...
# !!! check the folder path !!!
generate(rep, BASE_FOLDER  *  "/applications/workdays_weekends/weekends_paper/we2_2_lp_1_ip_5")
...
# !!! check the folder path !!!
jldsave(BASE_FOLDER*"/applications/workdays_weekends/weekends_paper/we2_2_lp_1_ip_5/infections_ag.jld2"; save_ag_data_base)

# !!! check the folder path !!!
save_ag_data = JLD2.load(BASE_FOLDER  *"/applications/workdays_weekends/weekends_paper/we2_2_lp_1_ip_5/infections_ag.jld2")["save_ag_data_base"]
