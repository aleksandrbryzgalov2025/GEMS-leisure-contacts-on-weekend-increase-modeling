...
########### Case of batch runs lp=4 ip =5 alternative gs 17.5 alternative ###################################
...
for i in 1:100
    sim = nothing
    sim = Simulation(BASE_FOLDER * "/applications/workdays_weekends/weekends_paper/lp_4_ip_5_alt/synth_pop_lp4_ip5_alt.toml", label = "alternative latent period 4")
...
generate(rep, BASE_FOLDER  *  "/applications/workdays_weekends/weekends_paper/lp_4_ip_5_alt")
...
# !!! check the folder path !!!
jldsave(BASE_FOLDER*"/applications/workdays_weekends/weekends_paper/lp_4_ip_5_alt/infections_ag.jld2"; save_ag_data_base)

# !!! check the folder path !!!
save_ag_data = JLD2.load(BASE_FOLDER  *"/applications/workdays_weekends/weekends_paper/lp_4_ip_5_alt/infections_ag.jld2")["save_ag_data_base"]
