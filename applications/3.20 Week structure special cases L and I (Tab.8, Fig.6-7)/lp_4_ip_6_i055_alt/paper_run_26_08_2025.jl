...
########### Case of batch runs lp=4 ip =6 alternative gs 17.5 i in hh 0.055 ###################################
...
# !!! check the folder path !!!
    sim = Simulation(BASE_FOLDER * "/applications/workdays_weekends/weekends_paper/lp_4_ip_6_i055_alt/synth_pop_lp4_ip6_i055_alt.toml", label = "alternative")
...
# !!! check the folder path !!!
generate(rep, BASE_FOLDER  *  "/applications/workdays_weekends/weekends_paper/lp_4_ip_6_i055_alt")
...
# !!! check the folder path !!!
jldsave(BASE_FOLDER*"/applications/workdays_weekends/weekends_paper/lp_4_ip_6_i055_alt/infections_ag.jld2"; save_ag_data_base)

# !!! check the folder path !!!
save_ag_data = JLD2.load(BASE_FOLDER  *"/applications/workdays_weekends/weekends_paper/lp_4_ip_6_i055_alt/infections_ag.jld2")["save_ag_data_base"]
