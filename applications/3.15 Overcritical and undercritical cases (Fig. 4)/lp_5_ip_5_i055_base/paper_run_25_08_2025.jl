...
########### Case of batch runs lp=5 ip =5 baseline gs 5 undercritical ###################################
...
for i in 1:100
    sim = nothing
    sim = Simulation(BASE_FOLDER * "/applications/workdays_weekends/weekends_paper/lp_5_ip_5_i055_base/synth_pop_lp5_ip5_i055_base.toml", label = "baseline undercritical?")
...
generate(rep, BASE_FOLDER  *  "/applications/workdays_weekends/weekends_paper/lp_5_ip_5_i055_base")
...
jldsave(BASE_FOLDER*"/applications/workdays_weekends/weekends_paper/lp_5_ip_5_i055_base/infections_ag.jld2"; save_ag_data_base)

# !!! check the folder path !!!
save_ag_data = JLD2.load(BASE_FOLDER  *"/applications/workdays_weekends/weekends_paper/lp_5_ip_5_i055_base/infections_ag.jld2")["save_ag_data_base"]
