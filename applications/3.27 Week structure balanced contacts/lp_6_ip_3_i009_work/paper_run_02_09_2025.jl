...
########### Case of batch runs lp=6 ip =3 alt i=0.09 in hh working contacts change ###################################
...
# !!! check the folder path !!!
    ...
    sim = Simulation(BASE_FOLDER * "/applications/workdays_weekends/weekends_paper/lp_6_ip_3_i009_work/synth_pop_lp6_ip3_i009_work.toml", label = "lp6 ip3 i009 working contacts")
...
# !!! check the folder path !!!
generate(rep, BASE_FOLDER  *  "/applications/workdays_weekends/weekends_paper/lp_6_ip_3_i009_work")
...
# !!! check the folder path !!!
jldsave(BASE_FOLDER*"/applications/workdays_weekends/weekends_paper/lp_6_ip_3_i009_work/infections_ag.jld2"; save_ag_data_base)

# !!! check the folder path !!!
save_ag_data = JLD2.load(BASE_FOLDER  *"/applications/workdays_weekends/weekends_paper/lp_6_ip_3_i009_work/infections_ag.jld2")["save_ag_data_base"]
