...
########### Case of batch runs lp=1 ip =5 alternative gs 5 alternative increased contact 4.2/ 8.4 work/ School ###################################
################################### on working days #################################
# No  distributions for the infectious period and the latent period ##################
...
# !!! check the folder path !!!
    ...
    sim = Simulation(BASE_FOLDER * "/applications/workdays_weekends/weekends_paper_additional/lp_1_ip_5_alt_work/synth_pop_lp1_ip5_alt_work.toml", label = "alternative L=1")
...
# !!! check the folder path !!!
generate(rep, BASE_FOLDER  *  "/applications/workdays_weekends/weekends_paper_additional/lp_1_ip_5_alt_work")
...
# !!! check the folder path !!!
jldsave(BASE_FOLDER*"/applications/workdays_weekends/weekends_paper_additional/lp_1_ip_5_alt_work/infections_ag.jld2"; save_ag_data_base)

# !!! check the folder path !!!
save_ag_data = JLD2.load(BASE_FOLDER  *"/applications/workdays_weekends/weekends_paper_additional/lp_1_ip_5_alt_work/infections_ag.jld2")["save_ag_data_base"]
