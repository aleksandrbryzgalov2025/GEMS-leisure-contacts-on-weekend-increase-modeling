...
########### Case of batch runs lp=6 ip =3 alternative mixed ###################################
...
for i in 1:100
    sim = nothing
    sim = Simulation(BASE_FOLDER * "/applications/workdays_weekends/weekends_paper/lp_6_ip_3_mixed/synth_pop_lp6_ip3_mixed.toml", label = "lp6 ip3 mixed")
...
generate(rep, BASE_FOLDER  *  "/applications/workdays_weekends/weekends_paper/lp_6_ip_3_mixed")
...
# !!! check the folder path !!!
jldsave(BASE_FOLDER*"/applications/workdays_weekends/weekends_paper/lp_6_ip_3_mixed/infections_ag.jld2"; save_ag_data_base)

# !!! check the folder path !!!
save_ag_data = JLD2.load(BASE_FOLDER  *"/applications/workdays_weekends/weekends_paper/lp_6_ip_3_mixed/infections_ag.jld2")["save_ag_data_base"]
