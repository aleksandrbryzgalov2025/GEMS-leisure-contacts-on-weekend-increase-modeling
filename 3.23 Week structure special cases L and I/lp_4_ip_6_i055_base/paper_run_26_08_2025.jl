...
########### Case of batch runs lp=4 ip =6 baseline gs5 infectivity hh 0.055 ###################################
...
# !!! check the folder path !!!
    ...
    sim = Simulation(BASE_FOLDER * "/applications/workdays_weekends/weekends_paper/lp_4_ip_6_i055_base/synth_pop_lp4_ip6_i055_base.toml", label = "baseline")
...
# !!! check the folder path !!!
generate(rep, BASE_FOLDER  *  "/applications/workdays_weekends/weekends_paper/lp_4_ip_6_i055_base")
...
# !!! check the folder path !!!
jldsave(BASE_FOLDER*"/applications/workdays_weekends/weekends_paper/lp_4_ip_6_i055_base/infections_ag.jld2"; save_ag_data_base)

# !!! check the folder path !!!
save_ag_data = JLD2.load(BASE_FOLDER  *"/applications/workdays_weekends/weekends_paper/lp_4_ip_6_i055_base/infections_ag.jld2")["save_ag_data_base"]
