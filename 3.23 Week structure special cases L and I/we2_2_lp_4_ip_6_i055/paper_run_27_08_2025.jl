...
########### Case of batch runs lp= 4 ip=6, i=0.055 in hh 2 after 2 WE days ###################################
#  ##################
...
# !!! check the folder path !!!
    ...
    sim = Simulation(BASE_FOLDER*"/applications/workdays_weekends/weekends_paper/we2_2_lp_4_ip_6_i055/synth_pop_lp4_ip6_i055_we2_2.toml", label = "Workdays 2 weekends 2 lp6")
    run!(sim)
...
# !!! check the folder path !!!
generate(rep, BASE_FOLDER  *  "/applications/workdays_weekends/weekends_paper/we2_2_lp_4_ip_6_i055")
...
# !!! check the folder path !!!
jldsave(BASE_FOLDER*"/applications/workdays_weekends/weekends_paper/we2_2_lp_4_ip_6_i055/infections_ag.jld2"; save_ag_data_base)

# !!! check the folder path !!!
save_ag_data = JLD2.load(BASE_FOLDER  *"/applications/workdays_weekends/weekends_paper/we2_2_lp_4_ip_6_i055/infections_ag.jld2")["save_ag_data_base"]
